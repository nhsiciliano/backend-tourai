...
const envSchemaDefinition = Type.Object({
  ...
  TTS_PROVIDER: Type.Union([Type.Literal('google'), Type.Literal('elevenlabs')], { default: 'google' }),
  GOOGLE_CLOUD_TTS_CREDENTIALS_BASE64: Type.Optional(Type.String()),
  GOOGLE_TTS_LANGUAGE_CODE_ES: Type.String({ default: 'es-US' }),
  GOOGLE_TTS_LANGUAGE_CODE_EN: Type.String({ default: 'en-US' }),
  GOOGLE_TTS_VOICE_ES: Type.String({ default: 'es-US-Neural2-A' }),
  GOOGLE_TTS_VOICE_EN: Type.String({ default: 'en-US-Neural2-D' }),
  ELEVENLABS_API_KEY: Type.Optional(Type.String()),
